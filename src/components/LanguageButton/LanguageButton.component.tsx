...
const LanguageButton: React.FC<ILanguageButtonProps> = ({ setLanguage }) => {
  ...
  return (
    <div className="row-center text-xs md:mt-2">
      <span
        className="text-custom-main/50 cursor-pointer rounded-full hover:bg-custom-second hover:text-white transition-300 px-2 py-1"
